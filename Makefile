...
.PHONY: all clean dist frontend binary test help version
...
help:
	...
	@echo ""
	@echo "  all         Clean build → dist bundle"
	@echo "  frontend    Build Vue.js frontend"
	@echo "  binary      Build amd64 static binary"
	@echo "  dist        Assemble release bundle"
	@echo "  test        Run tests"
	@echo "  clean       Remove build artifacts"
	@echo "  version     Show version info"
	@echo ""
	@echo "Override: make GOARCH=arm64 binary  (cross-compile)"
