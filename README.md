...
[![Release](https://img.shields.io/badge/release-v1.2.1-blue.svg)](https://github.com/DanilenkA/awg-portal/releases)
...
wget https://github.com/DanilenkA/awg-portal/releases/download/v1.2.1/awg-portal-v1.2.1-bundle.tar.gz
tar xzf awg-portal-v1.2.1-bundle.tar.gz
cd awg-portal-v1.2.1/
