...
[![Release](https://img.shields.io/badge/release-v1.0.1-blue.svg)](https://github.com/DanilenkA/awg-portal/releases)
...
Релизный бандл включает всё необходимое: wg-portal, amneziawg-go, install.sh, пример конфига.

```bash
# 1. Скачать и распаковать релиз
wget https://github.com/DanilenkA/awg-portal/releases/download/v1.0.1/awg-portal-v1.0.1-bundle.tar.gz
tar xzf awg-portal-v1.0.1-bundle.tar.gz
cd awg-portal-v1.0.1/

# 2. Установить (от root)
sudo bash install.sh

# 3. Отредактировать конфиг
sudo nano /opt/wg-portal/config.yml
# Обязательно: admin_user, admin_password, server.interface.listen_address
...
```bash
# Собрать amneziawg-go (требуется Go 1.21+)
git clone https://github.com/amnezia-vpn/amneziawg-go
cd amneziawg-go
CGO_ENABLED=0 go build -o /usr/local/bin/amneziawg-go -tags netgo .

# Скачать и установить wg-portal
wget https://github.com/DanilenkA/awg-portal/releases/download/v1.0.1/wg-portal-amd64
...
# Результат:
ls -lh dist/
# wg-portal-amd64   42 MB  статический ELF, stripped
