...
| Нода | Роль | IP |
|------|------|----|
| DNS-NODE | wg-portal сервер | 10.130.130.100 |
| Monitoring-NODE | Клиент (peer) | 10.130.130.60 |

**Порт 51820 — особенность:** на уровне гипервизора (Proxmox KVM) порт 51820 блокируется для kernel WireGuard. AWG userspace на этом порту работает. Рабочий порт для kernel WG — 51825.
